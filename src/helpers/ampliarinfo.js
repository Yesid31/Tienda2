...
export async function EjecutarApiTasa() {
    ...
    let response = await fetch(
      "https://alpha-vantage.p.rapidapi.com/query?to_currency=USD&function=CURRENCY_EXCHANGE_RATE&from_currency=COP",
      options
    );
  ...
  function ConvertirMoneda(tasa) {
    ...
    let precioUSD = infoProducto.precio * cantidad.value * tasa;
